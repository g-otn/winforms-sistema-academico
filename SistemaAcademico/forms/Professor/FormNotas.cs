...
namespace SistemaAcademico.forms.Professor
{
    public partial class FormNotas : Form
    {
        ...
        public FormNotas(int idUsuario)
        {
            InitializeComponent();
            idProfessor = new ExecutarDB().ListarProfessores("id", "professores", $"user_id = {idUsuario}")[0].ID;
            resgatarCursos();
        }
        ...
        private void cmbCurso_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // Resgata todos as matérias do curso selecionado no cmbCurso no qual o professor leciona e preenche no cmbMaterias
            foreach (Materia materia in new ExecutarDB().ListarMaterias("nome", "materias", $"curso = '{cmbCurso.Text}' AND lecionador_id = {idProfessor} ORDER BY nome ASC"))
